...
export default function PageControls({currPage, prev, next, hasPrev, hasNext}){
    ...
    return(
        ...
        <div className = 'flex items-center justify-center gap-5 rounded-lg text-gray-700 bg-white border-2 border-gray-200 px-5'>
            ...
            <span className = 'text-md'>{currPage}</span>
